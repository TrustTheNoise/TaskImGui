...
#include "../headers/glfw3.h" // Will drag system OpenGL headers
...
int main(int, char**)
{
    ...
    GLFWwindow* window
        = glfwCreateWindow(600, 500, "TaskImGui", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Set imgui windows size like opengl window size
