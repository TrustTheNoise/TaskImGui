...
namespace MyApp {
    ...
    void RenderUI()
    {
        ...
        if (win1_button && push_color) ImGui::PopStyleColor();
        ...
        if (win2_button && push_color) ImGui::PopStyleColor();

        if (win2_button) SecondWin();

        if (win1_button) FirstWin();
        ImGui::End();
    }
    ...
    static void FirstWin()
    {
        ...
        unsigned char* image_data = stbi_load("../Image/cat.jpg", &image_width,
                                              &image_height, NULL, 4);
        ...
        ImGui::BeginChild(
            "ChildLeft", ImVec2(ImGui::GetWindowContentRegionWidth() * 0.5f, 0),
        ...
        ImGui::BeginChild(
            "ChildRight",
            ImVec2(ImGui::GetWindowContentRegionWidth() * 0.5f, 0), true,
            ImGuiWindowFlags_None);
        ImGui::InputTextMultiline(
            "##InputText", Input, IM_ARRAYSIZE(Input),
        ...
        if (ImGui::Button("Clear")) { memset(Output, 0, sizeof(Output)); }
    ...
    static void SecondWin()
    {
        ...
        ImGui::GetWindowDrawList()->AddCircle(
            ImVec2(250, 100), 50.0f, IM_COL32(0, 255, 0, 255), 12, 2.0f);
        ImGui::GetWindowDrawList()->AddRect(ImVec2(350, 50), ImVec2(450, 150),
                                            IM_COL32(0, 0, 255, 255), 0.0f, 0,
                                            2.0f);
        ImGui::EndChild();
